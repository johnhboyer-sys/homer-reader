...
- **The "Bay of Troy"/Kesik basin** hypothesis (Zangger; Jablonka and Kayan on water
  engineering) proposes an artificial rectangular basin c. 330 × 230 m at Kesik, cut through
  the 40 m Yeniköy ridge, functioning as a naval station. **This is contested and thinly
  evidenced** — sedimentation patterns are ambiguous and diagnostic artefacts are absent.
  Flag it as a hypothesis, not a finding.
...
hydrochemical survey (Wolkersdorfer, Stadler et al., in *Geochemistry*) measured candidate
