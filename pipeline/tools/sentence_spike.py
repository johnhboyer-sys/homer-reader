...
from homer_pipeline.align import similarity
from homer_pipeline.align.aligner import align_chapter, split_sentences
from homer_pipeline.align.glossing import chapter_lines, is_tick, load_gloss
from homer_pipeline.align.reference import default_target, load_chapters, load_gloss_chapters
from homer_pipeline.config import BUILD_DIR
...
def _ostwald_target(book: int):
    ...
    from homer_pipeline.stage1_ostwald import apply_corrections, parse_ostwald
