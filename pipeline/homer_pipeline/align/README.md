...
```bash
cd pipeline
python -m homer_pipeline.align --books 1            # align Ross, Book 1
python -m homer_pipeline.align                      # whole corpus
python -m homer_pipeline.align --eval               # offset-error harness
python -m homer_pipeline.align --backend quality    # use mpnet embeddings
```
