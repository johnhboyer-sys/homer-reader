...
def _stub_epithets(data_dir, work_id: str = "testwork") -> None:
    # _validate_apparatus_epithets_emitted requires build/dist/<work>/epithets.json
    # to exist for every verse work; tests that aren't exercising THAT check stub
    # it out so they stay focused on what they actually test.
