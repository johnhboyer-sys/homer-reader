...
`homer_pipeline.align`'s `default_target("Cat")` returns Taylor (the
...
from homer_pipeline.align.aligner import align
from homer_pipeline.config import SOURCES_DIR, Manifest
